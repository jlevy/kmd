...
web_light_translucent = SimpleNamespace(
    ...
    bg=hsl_to_hex("hsla(44, 6%, 100%, 0.87)"),
    bg_header=hsl_to_hex("hsla(188, 12%, 80%, 0.8)"),
    bg_alt=hsl_to_hex("hsla(44, 28%, 90%, 0.75)"),
    text=hsl_to_hex("hsl(188, 39%, 11%)"),
    border=hsl_to_hex("hsl(188, 8%, 50%)"),
    border_hint=hsl_to_hex("hsla(188, 8%, 72%, 0.7)"),
    border_accent=hsl_to_hex("hsla(305, 18%, 65%, 0.875)"),
