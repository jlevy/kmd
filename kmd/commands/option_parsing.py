...
def parse_shell_args(args: List[str]) -> Tuple[List[str], Dict[str, Optional[str]]]:
    """
    Parse input arguments into positional and keyword arguments.
    """
    pos_args = []
    kw_args = {}
...
def test_parse_shell_args():
    ...
    assert pos_args == [
        ...
        "pos2",
        "pos3",
    ], f"Expected ['pos1', 'pos2', 'pos3'], but got {pos_args}"
    assert kw_args == {
        "key1": "value1",
        "key2": None,
        "k3": "value3",
    }, f"Expected {{'key1': 'value1', 'key2': None, 'k3': 'value3'}}, but got {kw_args}"

    print("test_parse_shell_args passed")
